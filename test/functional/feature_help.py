...
"""Verify that starting dogecash with -h works as expected."""
...
class HelpTest(DogeCashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dogecash with -? for help text")
        ...
        self.log.info("Start dogecash with -version for version information")
