...
- Create dogecashds that connect to them
- Manipulate the dogecashds using addnode (onetry) an observe effects
...
class ProxyTest(DogeCashTestFramework):
    ...
    def node_test(self, node, proxies, auth, test_onion=True):
        ...
        # Note: dogecashd's SOCKS5 implementation only sends atyp DOMAINNAME, even if connecting directly to IPv4/IPv6
