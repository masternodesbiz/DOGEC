...
<context>
    ...
    <message>
        ...
        <translation>Вместо того, чтобы делиться только адресом DogeCash, вы можете создать запрос на оплату, связывая больше информации</translation>
    </message>
    <message>
...
 </translation>
    ...
    <message>
        ...
        <translation>
Мастернода - это компьютер, на котором запущен базовый кошелек DogeCash с полным узлом и для которого требуется обеспечение в 10000 DOGEC для обеспечения дополнительных услуг сети и, в свою очередь, регулярного получения части вознаграждения за блок. Эти услуги в себя включают:
