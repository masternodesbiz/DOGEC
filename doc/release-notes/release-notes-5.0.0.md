DogeCash Core version *v5.0.0* is now available from:  <https://github.com/dogecash-project/pivx/releases>
    ...
    "spends" : [
      {
        ...
        "address" : "pivxaddress",      (string) The DogeCash address involved in the transaction
