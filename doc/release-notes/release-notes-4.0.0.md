DogeCash Core version *v4.0.0* is now available from:  <https://github.com/dogecash-project/pivx/releases>
...
For our linux users, in addition to the [Ubuntu PPA](https://launchpad.net/~pivx) repository, we are now offering a [Snap package](https://snapcraft.io/dogecash-core) as quick way to install and update a DogeCash wallet.
